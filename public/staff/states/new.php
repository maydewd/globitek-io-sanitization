...
<div id="main-content">
  <a href="../countries/show.php?id=<?php echo u($state['country_id']); ?>">Back to Country Details</a><br />

  <h1>New State</h1>

  <?php echo display_errors($errors); ?>

  <form action="new.php?country_id=<?php echo u($state['country_id']); ?>" method="post">
    Name:<br />
