...
<div id="main-content">
  ...
  <h1>Edit User: <?php echo h($user['first_name'] . " " . $user['last_name']); ?></h1>

  <?php echo display_errors($errors); ?>

  <form action="edit.php?id=<?php echo u($user['id']); ?>" method="post">
    First name:<br />
  ...
  <br />
  <a href="show.php?id=<?php echo u($user['id']); ?>">Cancel</a>
