...
$associated_state_result = find_state_by_id($state_id);
$associated_state = db_fetch_assoc($associated_state_result);
?>
...
<div id="main-content">
  <a href="../states/show.php?id=<?php echo u($state_id); ?>">Back to State: <?php echo h($associated_state['name']); ?></a>
  <br />
  ...
  <?php
    ...
    echo "<td>" . h($associated_state['name']) . "</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>Position: </td>";
  ...
  ?>
  <br />
  <a href="edit.php?id=<?php echo u($territory['id']); ?>">Edit</a><br />
